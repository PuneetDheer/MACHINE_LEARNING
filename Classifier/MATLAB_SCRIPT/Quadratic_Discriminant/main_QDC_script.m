...
% 
function main_QDC_script(data_with_labels)
...
fprintf('\n')
tic
[ Train_Post_Prob, Train_max_Post_Prob, Train_max_dK, Train_Pred_class_dK, Train_Pred_class, class_mean_Init, class_covar_Init, prior_Init] = TRain_Quadratic_Discriminant_Classifier(Training_set,Training_label);
...
[ Test_Post_Prob, dK ] = Posterier_Prob(Testing_set, class_mean_Init, class_covar_Init, prior_Init);

[Test_max_Post_Prob, Test_Pred_class] = max(Test_Post_Prob,[],2);

[Test_max_dk, Test_Pred_class_dK] = max(dK,[],2);
...
[ GRid_Post_Prob, GRid_dK ] = Posterier_Prob(feature_grid, class_mean_Init, class_covar_Init, prior_Init);
